...
description: Помогает Opencode работать с проектом «Умная диагностика»: понимать структуру, запускать
сервис, вносить изменения, обновлять README, проверять ошибки и готовность к публикации
